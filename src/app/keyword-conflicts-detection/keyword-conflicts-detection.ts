...
@Component({
  selector: 'app-keyword-conflicts-detection',
  standalone: true,
  imports: [CommonModule, FormsModule, HttpClientModule],
  templateUrl: './keyword-conflicts-detection.html',
  styleUrls: ['./keyword-conflicts-detection.css']
})
export class KeywordConflictsDetection implements OnInit {
  ...
  loadFileTypes(): void {
    // Load file types specific to the 'keyword_conflicts' check
    const checkKey = 'keyword_conflicts';
    ...
    this.http.get<any>(apiUrl, { withCredentials: true }).subscribe({
      next: (response) => {
        ...
        console.log('File types loaded for keyword_conflicts check:', this.fileTypes);
      },
      error: (error) => {

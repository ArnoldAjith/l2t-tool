...
@Component({
  selector: 'app-day-of-week-optimization',
  standalone: true,
  imports: [CommonModule, FormsModule, HttpClientModule],
  templateUrl: './day-of-week-optimization.html',
  styleUrls: ['./day-of-week-optimization.css']
})
export class DayOfWeekOptimization implements OnInit {
  ...
  loadFileTypes(): void {
    // Load file types specific to the 'day_cpl' check
    const checkKey = 'day_cpl';
    ...
    this.http.get<any>(apiUrl, { withCredentials: true }).subscribe({
      next: (response) => {
        ...
        console.log('File types loaded for day_cpl check:', this.fileTypes);
      },
      error: (error) => {

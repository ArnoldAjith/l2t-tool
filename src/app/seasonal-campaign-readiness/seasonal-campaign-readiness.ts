...
@Component({
  selector: 'app-seasonal-campaign-readiness',
  standalone: true,
  imports: [CommonModule, FormsModule, HttpClientModule],
  templateUrl: './seasonal-campaign-readiness.html',
  styleUrls: ['./seasonal-campaign-readiness.css']
})
export class SeasonalCampaignReadiness implements OnInit {
  ...
  loadFileTypes(): void {
    // Load file types specific to the 'events' check
    const checkKey = 'events';
    ...
    this.http.get<any>(apiUrl, { withCredentials: true }).subscribe({
      next: (response) => {
        ...
        console.log('File types loaded for events check:', this.fileTypes);
      },
      error: (error) => {

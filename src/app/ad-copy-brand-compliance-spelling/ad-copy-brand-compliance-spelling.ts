...
@Component({
  selector: 'app-ad-copy-brand-compliance-spelling',
  standalone: true,
  imports: [CommonModule, FormsModule, HttpClientModule],
  templateUrl: './ad-copy-brand-compliance-spelling.html',
  styleUrls: ['./ad-copy-brand-compliance-spelling.css']
})
export class AdCopyBrandComplianceSpelling implements OnInit {
  ...
  loadFileTypes(): void {
    // Load file types specific to the 'compliance' check
    const checkKey = 'compliance';
    ...
    this.http.get<any>(apiUrl, { withCredentials: true }).subscribe({
      next: (response) => {
        ...
        console.log('File types loaded for compliance check:', this.fileTypes);
      },
      error: (error) => {

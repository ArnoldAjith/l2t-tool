...
@Component({
  selector: 'app-high-spend-non-converting-queries',
  standalone: true,
  imports: [CommonModule, FormsModule, HttpClientModule],
  templateUrl: './high-spend-non-converting-queries.html',
  styleUrls: ['./high-spend-non-converting-queries.css']
})
export class HighSpendNonConvertingQueries implements OnInit {
  ...
  loadFileTypes(): void {
    // Load file types specific to the 'non_conv' check
    const checkKey = 'non_conv';
    ...
    this.http.get<any>(apiUrl, { withCredentials: true }).subscribe({
      next: (response) => {
        ...
        console.log('File types loaded for non_conv check:', this.fileTypes);
      },
      error: (error) => {

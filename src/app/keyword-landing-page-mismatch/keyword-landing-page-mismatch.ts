...
@Component({
  selector: 'app-keyword-landing-page-mismatch',
  standalone: true,
  imports: [CommonModule, FormsModule, HttpClientModule],
  templateUrl: './keyword-landing-page-mismatch.html',
  styleUrls: ['./keyword-landing-page-mismatch.css']
})
export class KeywordLandingPageMismatch implements OnInit {
  ...
  loadFileTypes(): void {
    // Load file types specific to the 'term_lp_mismatch' check
    const checkKey = 'term_lp_mismatch';
    ...
    this.http.get<any>(apiUrl, { withCredentials: true }).subscribe({
      next: (response) => {
        ...
        console.log('File types loaded for term_lp_mismatch check:', this.fileTypes);
      },
      error: (error) => {

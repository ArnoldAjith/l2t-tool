...
@Component({
  selector: 'app-geo-segmentation-opportunities',
  standalone: true,
  imports: [CommonModule, FormsModule, HttpClientModule],
  templateUrl: './geo-segmentation-opportunities.html',
  styleUrls: ['./geo-segmentation-opportunities.css']
})
export class GeoSegmentationOpportunities implements OnInit {
  ...
  loadFileTypes(): void {
    // Load file types specific to the 'location_cpl' check
    const checkKey = 'location_cpl';
    ...
    this.http.get<any>(apiUrl, { withCredentials: true }).subscribe({
      next: (response) => {
        ...
        console.log('File types loaded for location_cpl check:', this.fileTypes);
      },
      error: (error) => {

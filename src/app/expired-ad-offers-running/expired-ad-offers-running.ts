...
@Component({
  selector: 'app-expired-ad-offers-running',
  standalone: true,
  imports: [CommonModule, FormsModule, HttpClientModule],
  templateUrl: './expired-ad-offers-running.html',
  styleUrls: ['./expired-ad-offers-running.css']
})
export class ExpiredAdOffersRunning implements OnInit {
  ...
  loadFileTypes(): void {
    // Load file types specific to the 'expiry' check
    const checkKey = 'expiry';
    ...
    this.http.get<any>(apiUrl, { withCredentials: true }).subscribe({
      next: (response) => {
        ...
        console.log('File types loaded for expiry check:', this.fileTypes);
      },
      error: (error) => {

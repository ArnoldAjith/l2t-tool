...
@Component({
  selector: 'app-pmax-asset-engagement',
  standalone: true,
  imports: [CommonModule, FormsModule, HttpClientModule],
  templateUrl: './pmax-asset-engagement.html',
  styleUrls: ['./pmax-asset-engagement.css']
})
export class PmaxAssetEngagement implements OnInit {
  ...
  loadFileTypes(): void {
    // Load file types specific to the 'engagement' check
    const checkKey = 'engagement';
    ...
    this.http.get<any>(apiUrl, { withCredentials: true }).subscribe({
      next: (response) => {
        ...
        console.log('File types loaded for engagement check:', this.fileTypes);
      },
      error: (error) => {

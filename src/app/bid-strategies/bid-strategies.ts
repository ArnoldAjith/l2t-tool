...
@Component({
  selector: 'app-bid-strategies',
  imports: [CommonModule, TitleCasePipe],
  templateUrl: './bid-strategies.html',
  styleUrl: './bid-strategies.css'
})
export class BidStrategies implements OnInit {
  ...
  loadAdsData(): void {
    ...
    const fileName = "AdGroupSettings";
  ...
  exportToExcel(): void {
    ...
    try {
      ...
      XLSX.utils.book_append_sheet(wb, ws, 'Bid Strategies');

      const fileName = `bid-strategies-${this.getCurrentDate()}.xlsx`;

...
@Component({
  selector: 'app-disapproved-ads-or-extensions',
  standalone: true,
  imports: [CommonModule, FormsModule, HttpClientModule],
  templateUrl: './disapproved-ads-or-extensions.html',
  styleUrls: ['./disapproved-ads-or-extensions.css']
})
export class DisapprovedAdsOrExtensions implements OnInit {
  ...
  loadFileTypes(): void {
    // Load file types specific to the 'adStatus' check
    const checkKey = 'adStatus';
    ...
    this.http.get<any>(apiUrl, { withCredentials: true }).subscribe({
      next: (response) => {
        ...
        console.log('File types loaded for adStatus check:', this.fileTypes);
      },
      error: (error) => {
